...
(define test-array-2 (list (list 1 2 3 4 5) (list 6 7 8 9 10) (list 11 12 13 14 15) (list 16 17 18 19 20)))

(define test-vector-1 (list 1 2 3 4))
(define test-vector-2 (list 1 2 3))
